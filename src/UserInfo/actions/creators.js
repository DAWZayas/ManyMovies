import { SET_WATCHED_USER, SET_WATCHED_USER_FOLLOWERS, SET_WATCHED_USER_FOLLOWING, CLEAR_WATCHED_USER_FOLLOWERS, CLEAR_WATCHED_USER_FOLLOWING, CLEAR_WATCHED_USER } from './constants';

export const setWatchedUser = watchedUser => ({type: SET_WATCHED_USER, watchedUser});
export const clearWatchedUser = () => ({type: CLEAR_WATCHED_USER});
